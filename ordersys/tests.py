...
class TestOrderCreationView(TestCase):
    def setUp(self):
        ...
        ingredient1 = Ingredient(name='TestIngre1', amount_stored=20)
        product.save()
        product2.save()
        ingredient1.save()
        ingamo1 = IngredientAmount(product=product, ingredient=ingredient1, amount=2)
        ingamo2 = IngredientAmount(product=product2, ingredient=ingredient1, amount=2)
        ingamo1.save()
        ingamo2.save()
        self.c = Client()
